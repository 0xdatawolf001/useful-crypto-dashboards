...
2. [growthepie](https://www.growthepie.com/): Ethereum ecosystem analytics (Ethereum Mainnet and Layer 2). Fundamentals and economics metrics, as well as application and data availability metrics.
